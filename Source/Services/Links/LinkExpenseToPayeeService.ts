...
export class LinkExpenseToPayeeService extends LinkService<ExpenseCreatedEvent, ExpenseProjection, PayeeProjection> {
  public static Instance: LinkExpenseToPayeeService = new LinkExpenseToPayeeService();
  private constructor() {
    const declaration = new LinkManySubjectsToOneTargetDeclaration<ExpenseCreatedEvent, ExpenseProjection, PayeeProjection>({
